...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/nodcoin/tx/%s|https://coinplorer.com/NDC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/NDC/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/nodcoin/tx/%s|https://coinplorer.com/NDC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/NDC/tx/%s").toString();
